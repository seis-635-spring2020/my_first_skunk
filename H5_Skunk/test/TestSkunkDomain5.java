...
class TestSkunkDomain5 {
	...
	int[] die1_rolls = new int[] { 3, 6, 5, 5, 1, 3, 4, 3, 2, 5, 5, 6, 1, 1, 6, 4, 6, 6 };
	int[] die2_rolls = new int[] { 3, 5, 6, 5, 1, 4, 5, 4, 5, 4, 1, 6, 2, 4, 2, 6, 6, 6 };
	...
	String case1 = "Welcome to Skunk 0.47\n" + 
			...
			"\n" + 
			"Round winner earns 8, finishing with 56\n" + 
			"\n" + 
