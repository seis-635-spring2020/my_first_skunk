...
class TestSkunkDomain1 {
	...
	int[] die1_rolls = new int[] { 3, 6, 5, 5, 1, 3, 4, 3, 2, 5, 5, 6, 1, 1, 6, 4, 2 };
	...
	String case1 = "Welcome to Skunk 0.47\n" + 
			...
			"Roll? y or n => y\n" + 
			"Roll is Dice with last roll: 3 => 2 + 1\n" + 
			"\n" + 
			"Skunks and Deuce! You lose the turn, the turn score, plus pay 2 chips to the kitty\n" + 
			"Last roll of Dice with last roll: 3 => 2 + 1, giving final round score of 0\n" + 
			"Final round score for Player 1 is 104.\n" + 
			"Final round score for Player 2 is 0.\n" + 
			"Round winner is Player 1 with score of 104\n" + 
			"\n" + 
			"Round winner earns 10, finishing with 58\n" + 
			"\n" + 
